...
Shader "Stars"
{
	Properties
	{
		...
		_Color("Color", Color) = (0.5960751,0.8962264,0.8596405,0.2392157)
		[ASEEnd]_Brightness("Brightness", Float) = 10
	...
	SubShader
	{
		...
		Pass
		{
			...
			#define _Brightness UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float , Metadata__Brightness)
			#endif
						...
						)
			{
				...
				surfaceDescription.Emission = ( _Color * _Brightness ).rgb;
